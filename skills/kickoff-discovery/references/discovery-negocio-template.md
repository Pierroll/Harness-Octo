...
operaciones, compras, proveedores, comercial, marketing y frentes equivalentes.

## Cuándo usar esta plantilla

- Discovery de un módulo funcional (por ejemplo homologación, licitaciones, catálogo o CRM)
...
- *Lista actual de documentos que se exigen a [los proveedores/clientes/usuarios] para [acción específica] (RUC, vigencia poder, ficha RUC, estados financieros, certificaciones y los que el cliente agregue).*
...
- **Sin pensar en el sistema: ¿cómo pasa esto en la realidad?** *(Que lo cuenten como
  historia, de principio a fin, sin nombrar pantallas ni software. Si solo se pregunta por
  el sistema actual, lo que sale después es una copia con mejor interfaz.)*
- ¿Cuál es el proceso actual completo? ¿Por dónde entra [una transacción/solicitud/caso] nueva?
- ¿Qué partes del proceso hoy pasan fuera del sistema? (WhatsApp, Excel, papel, llamadas)
...
- ¿Qué áreas participan en la aprobación? *(listar las áreas que el contexto sugiera: Logística, Legal, Finanzas)*
...
- **Estados de [la entidad principal]:** ¿en qué estados puede estar, qué la mueve de uno a
  otro, quién lo dispara y qué tiene que pasar cuando cambia? *(Cada transición suele ser
  una notificación, una pantalla o un permiso que cambia. Es de lo que más se olvida
  preguntar.)*
- **Quién es la persona detrás del cargo:** de los roles que nombraron, ¿cuántos son,
  cómo trabajan, qué nivel técnico tienen, en qué idioma o registro hay que hablarles, y si
  están en escritorio o en campo. *(El cargo no alcanza: dos roles con el mismo nombre
  pueden ser dos poblaciones distintas.)*
