...
- Abre siempre por el proceso real, sin nombrar el sistema: cómo pasa esto en la vida, de
  principio a fin. El sistema actual se pregunta después.
- Qué partes del proceso hoy pasan fuera del sistema.
...
- Estados de la entidad principal: cuáles son, qué mueve de uno a otro, quién lo dispara y
  qué debe pasar cuando cambia.
- Quién es la persona detrás de cada rol: cuántos son, nivel técnico, idioma, y si trabajan
  en escritorio o en campo.
...
- Roles internos esperados: super-admin (todo el grupo), admin de empresa, y los que el proyecto defina.
