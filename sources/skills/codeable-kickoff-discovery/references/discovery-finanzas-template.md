...
- Discovery sobre estados de transacciones (pendiente, programado, pagado, etc.).
- Discovery sobre retenciones, impuestos, condiciones de pago, constancias.
- El dueño del lado del cliente es Tesorería, CFO, Contralor, etc.
...
- *Listado de condiciones de pago vigentes con [proveedores/clientes] (30/60/90 días, contado, etc.).*
...
3. **Retenciones e impuestos varían por país** — verificar si aplica IGV (Perú), IVA (México/Colombia), etc.
